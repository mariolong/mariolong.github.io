...
BLOG_AUTHOR = "Mario Long"  # (translatable)
BLOG_TITLE = "Simple Life"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://github.com/mariolong/mariolong.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://mariolong.github.io/"
BLOG_EMAIL = "mariolong5782@gmail.com"
BLOG_DESCRIPTION = "Simple is beautiful. Note for health, computer and investment."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/categories/cat_computer/", "電腦"),
        ("/categories/cat_investment/", "投資"),
        ("/categories/cat_life/", "生活"),
        ("/archive.html", "歸檔"),
        ("/rss.xml", "訂閱"),
    ),
}
